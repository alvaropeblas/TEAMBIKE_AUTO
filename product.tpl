...
{block name='head_og_tags'}
    ...
    {if isset($product.external_image_url) && $product.external_image_url != ''}
        <meta property="og:image" content="{$product.external_image_url}">
    {else}
...
{block name='content'}
                    ...
                    <section class="page-content" id="content">
                        {block name='page_content'}
                            ...
                            {block name='product_cover_thumbnails'}
                                {if isset($product.external_image_url) && $product.external_image_url != ''}
                                    <img src="{$product.external_image_url}" alt="{$product.name}" class="product-cover-image">
                                {else}
                ...
                {if $accessories}
                    <section class="product-accessories block block-section">
                        ...
                        <div class="block-content">
                            <div id="product-accessories-carrusel">
                                {foreach from=$accessories item="product_accessory"}
                                    {block name='product_miniature'}
                                        {include file='catalog/_partials/miniatures/product-carousel.tpl' product=$product_accessory}
                                    {/block}
                                {/foreach}
                            </div>
                        </div>
    ...
    {block name='product_fixed_bar'}
        {include file='catalog/_partials/_product_partials/product-fixed-bar.tpl'}  
    {/block}
{/block}
